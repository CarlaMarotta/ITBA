...
#se agregan las siguientes variables solo a los efectos de experimentar. Estas variables sí tienen valor en el dataset
  dataset[ foto_mes==202103,  active_quarter   := NA ]
  dataset[ foto_mes==202103,  mrentabilidad   := NA ]
  dataset[ foto_mes==202103,  mrentabilidad_annual   := NA ]
  dataset[ foto_mes==202103,  mcomisiones   := NA ]
  dataset[ foto_mes==202103,  mactivos_margen   := NA ]
  dataset[ foto_mes==202103,  mpasivos_margen   := NA ]
  dataset[ foto_mes==202103,  mcuentas_saldo   := NA ]
  dataset[ foto_mes==202103,  ctarjeta_debito_transacciones  := NA ]
  dataset[ foto_mes==202103,  mautoservicio   := NA ]
  dataset[ foto_mes==202103,  ctarjeta_visa_transacciones   := NA ]
  dataset[ foto_mes==202103,  mtarjeta_visa_consumo   := NA ]
  dataset[ foto_mes==202103,  ctarjeta_master_transacciones  := NA ]
  dataset[ foto_mes==202103,  mtarjeta_master_consumo   := NA ]
  dataset[ foto_mes==202103,  ccomisiones_otras   := NA ]
  dataset[ foto_mes==202103,  mcomisiones_otras   := NA ]
  dataset[ foto_mes==202103,  cextraccion_autoservicio   := NA ]
  dataset[ foto_mes==202103,  mextraccion_autoservicio   := NA ]
  dataset[ foto_mes==202103,  ccheques_depositados   := NA ]
  dataset[ foto_mes==202103,  mcheques_depositados   := NA ]
  dataset[ foto_mes==202103,  ccheques_emitidos   := NA ]
  dataset[ foto_mes==202103,  mcheques_emitidos   := NA ]
  dataset[ foto_mes==202103,  ccheques_depositados_rechazados   := NA ]
  dataset[ foto_mes==202103,  mcheques_depositados_rechazados   := NA ]
  dataset[ foto_mes==202103,  ccheques_emitidos_rechazados   := NA ]
  dataset[ foto_mes==202103,  mcheques_emitidos_rechazados   := NA ]
  dataset[ foto_mes==202103,  tcallcenter   := NA ]
  dataset[ foto_mes==202103,  ccallcenter_transacciones   := NA ]
  dataset[ foto_mes==202103,  thomebanking   := NA ]
  dataset[ foto_mes==202103,  chomebanking_transacciones   := NA ]
  dataset[ foto_mes==202103,  ccajas_transacciones   := NA ]
  dataset[ foto_mes==202103,  ccajas_consultas   := NA ]
  dataset[ foto_mes==202103,  ccajas_depositos   := NA ]
  dataset[ foto_mes==202103,  ccajas_extracciones   := NA ]
  dataset[ foto_mes==202103,  ccajas_otras   := NA ]
  dataset[ foto_mes==202103,  catm_trx   := NA ]
  dataset[ foto_mes==202103,  matm   := NA ]
  dataset[ foto_mes==202103,  catm_trx_other   := NA ]
  dataset[ foto_mes==202103,  matm_other   := NA ]
  dataset[ foto_mes==202103,  ctrx_quarter   := NA ]
  dataset[ foto_mes==202103,  cmobile_app_trx   := NA ]
